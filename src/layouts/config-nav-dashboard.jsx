...
export const useNavData = () => {
  ...
  const settingsChildren = [
    ...
    { title: 'Quick Replies', path: paths.dashboard.settings.quickreplies, alwaysVisible: true },
    ...
    { title: 'Notification Preferences', path: paths.dashboard.settings.notificationpreferences, alwaysVisible: true },
    { title: 'Time Zone', path: paths.dashboard.settings.timezone },
  ].filter(item => item.alwaysVisible || !teammembersPageDisabled);
